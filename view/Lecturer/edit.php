  ...
  <div class="col-lg-6 m-auto">
    ...
    <form method="post">
      ...
      <div class="card">
        ...
        <input type="hidden" name="id" value="<?php echo $data['id']; ?>" class="form-control"> <br>

        <label> NAME: </label>
        <input type="text" name="name" value="<?php echo $data['name']; ?>" class="form-control"> <br>

        <label> NIDN: </label>
        <input type="text" name="nidn" value="<?php echo $data['nidn']; ?>" class="form-control"> <br>

        <label> PHONE: </label>
        <input type="text" name="phone" value="<?php echo $data['phone']; ?>" class="form-control"> <br>

        <label> JOIN DATE: </label>
        <input type="date" name="join_date" value="<?php echo $data['join_date']; ?>" class="form-control"> <br>
